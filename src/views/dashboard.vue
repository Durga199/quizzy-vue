<template>
  <div class="flex w-full h-screen justify-center items-center">
    ...
    <div class="dv2">
      ...
      <button class=" float-left ml-36 mr-4 rounded bg-purple-700 text-white font-bold py-2 px-4  hover:bg-green-900">
        <router-link to="/instruction">GO TO Home</router-link>
      </button>
      <button @click="logout" class="rounded float-right mr-36 ml-8 bg-red-700 text-white font-bold py-2 px-4 hover:bg-blue-900">
       Quit
      </button>
    </div>
    <div v-if="count == 1">
      <h1 class="font-bold  text-red-900 text-3xl text-center">
        ...
        <button class=" float-left ml-36 mr-4 rounded bg-purple-700 text-white font-bold py-2 px-4  hover:bg-green-900">
        <router-link to="/category">Return Home</router-link>
      </button>
